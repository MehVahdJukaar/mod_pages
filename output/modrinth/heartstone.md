...
**Q: Does it work cross-dimension?**

**A:** Yes - it tracks your partner across dimensions, though the direction pointer only works if you're in the same dimension.

**Q: What happens if I lose my heartstone?**

**A:** If the *other* player dies, your stone breaks. If you lose your own, you'll need to reclaim it (it won't function while on the ground).
