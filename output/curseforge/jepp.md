...
<p><span style="font-size:18px">Paintings in Minecraft are a lottery. You place one, you get whatever the game feels like giving you, and the only way to find the one you wanted is to place it over and over.</span></p>

<p><span style="font-size:18px">JEPP is a small JEI/REI addon that adds a recipe category for paintings, so you can just look them up instead. Point at a painting and press <strong>U</strong> and you get a window with every painting available to you.</span></p>

<p><span style="font-size:18px">Each entry shows the painting's name, its dimensions and which mod adds it. It works with any mod that adds paintings, no configuration needed.</span></p>

<p style="text-align:center"><img src="https://raw.githubusercontent.com/MehVahdJukaar/mod_pages/master/assets/separators/magenta.png" alt="separator" width="1688" height="42"></p>

<p style="text-align:center"><span style="font-size:24px"><strong>🖼️ Media 🖼️</strong></span></p>

<p style="text-align:center"><img src="https://i.imgur.com/Y6UHsCt.png" alt="The painting preview window in JEI"></p>

<p style="text-align:center"><img src="https://raw.githubusercontent.com/MehVahdJukaar/mod_pages/master/assets/separators/magenta.png" alt="separator" width="1688" height="42"></p>

<p style="text-align:center"><span style="font-size:24px"><strong>❓ F.A.Q. ❓</strong></span></p>

<p><span style="font-size:18px"><strong>Q: Do I need JEI or REI?</strong></span></p>

<p><span style="font-size:18px"><strong>A:</strong> One of the two, yes. JEPP is a plugin for them, it has no UI of its own.</span></p>

<p><span style="font-size:18px"><strong>Q: Is it client-side?</strong></span></p>

<p><span style="font-size:18px"><strong>A:</strong> Yes, it only adds a lookup screen. No server install needed.</span></p>

<p><span style="font-size:18px"><strong>Q: Does it work with paintings from other mods?</strong></span></p>

<p><span style="font-size:18px"><strong>A:</strong> Yes, automatically. Anything registered as a painting shows up.</span></p>
