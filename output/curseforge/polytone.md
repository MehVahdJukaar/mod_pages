...
<li><span style="font-size:18px">Custom <strong>Map Colors</strong></span></li>
<li><span style="font-size:18px">Change <strong>Spawn Egg Colors</strong></span></li>
<li><span style="font-size:18px">Day Time-Variant <strong>Animated Textures</strong></span></li>
...
<li><span style="font-size:18px">Modify <strong>Existing Particles</strong></span></li>
...
<p><strong>Items & UI</strong></p>

<ul>
<li><span style="font-size:18px">Custom <strong>Item Models</strong></span></li>
...
<li><span style="font-size:18px">Customize <strong>Creative Tabs</strong></span></li>
<li><span style="font-size:18px">Move <strong>GUI Slots</strong></span></li>
