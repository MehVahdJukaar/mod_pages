...
<p style="text-align:center"><img src="https://raw.githubusercontent.com/MehVahdJukaar/mod_pages/master/assets/separators/polytone.png" alt="separator" width="1688" height="42"></p>

<p style="text-align:center"><span style="font-size:24px"><strong>📖 About 📖</strong></span></p>

<p><span style="font-size:18px">Polytone is a client-side <strong>customization mod</strong> that allows extensive tweaking of nearly every visual and audio aspect of the game through <strong>Resource Packs</strong>.</span></p>

<p><span style="font-size:18px">It also offers <strong>full backwards compatibility</strong> with Optifine's <code>color.properties</code> system, so existing packs work out of the box - while offering far more options than Optifine ever did.</span></p>

<p><span style="font-size:18px">Full documentation and an example pack are available on the <a href="https://github.com/MehVahdJukaar/polytone/wiki"><strong>Wiki</strong></a>. Feel free to add Polytone to the optional dependency section of your resource pack!</span></p>

<p><span style="font-size:18px">Check the Files tab for actively supported versions.</span></p>

<p style="text-align:center"><img src="https://raw.githubusercontent.com/MehVahdJukaar/mod_pages/master/assets/separators/polytone.png" alt="separator" width="1688" height="42"></p>

<p style="text-align:center"><span style="font-size:24px"><strong>✨ Features ✨</strong></span></p>

<p><strong>🎨 Colors & Visuals</strong></p>

<ul>
<li><span style="font-size:18px">Custom <strong>Biome Colors & Particles</strong> 🌄</span></li>
<li><span style="font-size:18px">Custom <strong>Block Colormaps</strong> 🎨</span></li>
<li><span style="font-size:18px">Custom <strong>Fluid Colormaps</strong> 🍸</span></li>
<li><span style="font-size:18px">Custom <strong>Sky Colors</strong> 🌈</span></li>
<li><span style="font-size:18px">Custom <strong>Map Colors</strong> 🗺️</span></li>
<li><span style="font-size:18px">Change <strong>Spawn Egg Colors</strong> 🐣</span></li>
<li><span style="font-size:18px">Day Time-Variant <strong>Animated Textures</strong> ☀️</span></li>
<li><span style="font-size:18px">Block <strong>Offset Type</strong> 📐</span></li>
</ul>

<p><strong>💫 Particles & Shaders</strong></p>

<ul>
<li><span style="font-size:18px">Custom <strong>Client-Side Particles</strong> ✨</span></li>
<li><span style="font-size:18px"><strong>Entity Model Particle Emitters</strong> 🦋</span></li>
<li><span style="font-size:18px">Modify <strong>Existing Particles</strong> 🖌️</span></li>
<li><span style="font-size:18px">Customize <strong>Particle Colors</strong> 🍭</span></li>
<li><span style="font-size:18px">Custom <strong>Post Shaders</strong> 🌅</span></li>
</ul>

<p><strong>🎵 Audio</strong></p>

<ul>
<li><span style="font-size:18px">Custom <strong>Client-Side Sounds</strong> 🎵</span></li>
<li><span style="font-size:18px">Change <strong>Block Sounds</strong> 🪅</span></li>
<li><span style="font-size:18px">Register new <strong>Sound Events</strong> 🔔</span></li>
</ul>

<p><strong>🖼️ Items & UI</strong></p>

<ul>
<li><span style="font-size:18px">Custom <strong>Item Models</strong> 🗡️</span></li>
<li><span style="font-size:18px">Add/Remove <strong>Item Tooltips</strong> 🪡</span></li>
<li><span style="font-size:18px">Change <strong>Item Rarity</strong> 💍</span></li>
<li><span style="font-size:18px">Customize <strong>Creative Tabs</strong> 🏷️</span></li>
<li><span style="font-size:18px">Move <strong>GUI Slots</strong> 🗓️</span></li>
<li><span style="font-size:18px">Add <strong>GUI Elements</strong> 📒</span></li>
<li><span style="font-size:18px">Config screen to disable <strong>Pack Overlays</strong> 🔧</span></li>
</ul>

<p style="text-align:center"><img src="https://raw.githubusercontent.com/MehVahdJukaar/mod_pages/master/assets/separators/polytone.png" alt="separator" width="1688" height="42"></p>

<p style="text-align:center"><span style="font-size:24px"><strong>🔧 Compatibility 🔧</strong></span></p>

<p><span style="font-size:18px"><strong>Optifine:</strong> Polytone is a drop-in replacement for Optifine's <code>color.properties</code> system. Existing packs work automatically, and you gain many features Optifine never offered. See also: <a href="https://github.com/LambdAurora/optifine_alternatives">optifine_alternatives</a>.</span></p>

<p><span style="font-size:18px"><strong>Sodium:</strong> On 1.20, some features may not work with Sodium due to <a href="https://github.com/CaffeineMC/sodium-fabric/issues/2298">this upstream issue</a>. Consider using <strong>Embeddium</strong> instead for full compatibility.</span></p>

<p><span style="font-size:18px">Feel free to use the Polytone banner in your resource packs and share your creations in the comments!</span></p>

<p style="text-align:center"><img src="https://raw.githubusercontent.com/MehVahdJukaar/mod_pages/master/assets/separators/polytone.png" alt="separator" width="1688" height="42"></p>

<p style="text-align:center"><span style="font-size:24px"><strong>📦 Known Packs 📦</strong></span></p>

<p><span style="font-size:18px">Community resource packs using Polytone:</span></p>

<ul>
<li><span style="font-size:18px"><a href="https://modrinth.com/resourcepack/fogulous">Fogulous</a></span></li>
<li><span style="font-size:18px"><a href="https://modrinth.com/resourcepack/polyshader/gallery">Polyshader</a></span></li>
<li><span style="font-size:18px"><a href="https://modrinth.com/resourcepack/visual-effects-plus">Visual Effects Plus</a></span></li>
<li><span style="font-size:18px"><a href="https://www.planetminecraft.com/texture-pack/unique-goat-horns/">Unique Goat Horns</a></span></li>
<li><span style="font-size:18px"><a href="https://www.curseforge.com/minecraft/texture-packs/shrimps-distinct-potions">Shrimp's Distinct Potions</a></span></li>
<li><span style="font-size:18px"><a href="https://modrinth.com/resourcepack/variant-paintings">Variant Paintings</a></span></li>
<li><span style="font-size:18px"><a href="https://www.curseforge.com/minecraft/texture-packs/minecraft-reimagined">Minecraft Reimagined</a></span></li>
<li><span style="font-size:18px"><a href="https://modrinth.com/resourcepack/light-leak/version/1.4.0">Light Leak</a></span></li>
<li><span style="font-size:18px"><a href="https://www.curseforge.com/minecraft/texture-packs/golden-days">Golden Days</a></span></li>
<li><span style="font-size:18px"><a href="https://www.curseforge.com/minecraft/texture-packs/rainbows-foliage">Rainbows Foliage</a></span></li>
<li><span style="font-size:18px"><a href="https://modrinth.com/resourcepack/knishles-beautiful-colormap">Knishle's Beautiful Colormap</a></span></li>
<li><span style="font-size:18px"><a href="https://modrinth.com/resourcepack/sunbathing-godrays">Sunbathing Godrays</a></span></li>
</ul>

<p><span style="font-size:18px">Want your pack featured here? Contact me. Check the <strong>Dependents</strong> section to discover more packs in the wild.</span></p>
