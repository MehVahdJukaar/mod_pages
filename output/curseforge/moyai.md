...
<p><span style="font-size:18px">Adds Moyai to your game.</span></p>
...
<li><span style="font-size:18px">Affected by gravity, and deals heavy damage when it falls on an entity</span></li>
<li><span style="font-size:18px">Can be crafted into firework stars</span></li>
</ul>

<p><span style="font-size:18px">Note: the Fabric version is missing some of these features.</span></p>
