<p style="text-align:center">
  <a href="https://www.akliz.net/manage/aff.php?aff=372"><img src="https://i.imgur.com/G4k4MIs.png" alt="Amendments" width="1519" height="855"></a>
</p>
...
<ul>
<li><span style="font-size:18px">Carpeted Stairs</span></li>
<li><span style="font-size:18px">Better Lily Pads</span></li>
<li><span style="font-size:18px">Better Jukeboxes</span></li>
</ul>

<p><span style="font-size:18px">Requires <strong><a href="https://www.curseforge.com/minecraft/mc-mods/selene">Moonlight Library</a></strong>. You are free to include this mod in your modpacks.</span></p>
...
<p><span style="font-size:18px"><strong>A:</strong> Join our <a href="https://discord.com/invite/qdKRTDf8Cv"><strong>Discord</strong></a> for help, or open an issue on GitHub.</span></p>
...
<p><span style="font-size:18px"><strong>A:</strong> Make sure the <strong>Moonlight Generated Pack</strong> and <strong>Mod Assets</strong> have a higher priority than vanilla in your resource pack screen.</span></p>
...
<p><span style="font-size:18px"><strong>A:</strong> No. They work better.</span></p>
