...
<p><span style="font-size:18px">Advancement Frames adds wall plaques that display your advancements, so progress can be shown off in a base rather than buried in a menu.</span></p>
...
<ul>
<li><span style="font-size:18px"><strong>Advancement Frame</strong>: open its GUI and pick any advancement you have earned, or leave it empty</span></li>
<li><span style="font-size:18px">Displays the advancement's icon, and its name and the player who earned it when looked at</span></li>
<li><span style="font-size:18px">Shift-click a placed frame to show the advancement description instead</span></li>
<li><span style="font-size:18px">Losing an advancement clears it from the frame on the next save</span></li>
<li><span style="font-size:18px"><strong>Stat Frame</strong>: the same, for player statistics</span></li>
</ul>
